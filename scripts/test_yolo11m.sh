...
MODEL="${1:-${REPO_ROOT}/../models/yolo11m_416.onnx}"
OUTPUT="${2:-${REPO_ROOT}/build/test/models/yolo11m_416.tflite}"

if [[ ! -f "${MODEL}" ]]; then
  echo "YOLO11m model not found: ${MODEL}" >&2
  exit 1
fi
