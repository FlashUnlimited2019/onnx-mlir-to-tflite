...
MODEL="${1:-${REPO_ROOT}/../models/yolov5s_640.onnx}"
OUTPUT="${2:-${REPO_ROOT}/build/test/models/yolov5s_640.tflite}"

if [[ ! -f "${MODEL}" ]]; then
  echo "YOLOv5s model not found: ${MODEL}" >&2
  exit 1
fi
