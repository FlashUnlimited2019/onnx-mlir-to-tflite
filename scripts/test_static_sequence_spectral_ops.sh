...
MODEL="${1:-${REPO_ROOT}/../models/test_models_20260810/static_sequence_spectral_ops_sim.onnx}"
OUTPUT="${2:-${REPO_ROOT}/build/test/models/static_sequence_spectral_ops_sim.tflite}"
