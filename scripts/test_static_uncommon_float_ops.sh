...
MODEL="${1:-${REPO_ROOT}/../models/test_models_20260809/static_uncommon_float_ops_sim.onnx}"
OUTPUT="${2:-${REPO_ROOT}/build/test/models/static_uncommon_float_ops_sim.tflite}"
...
# ONNX Runtime 1.23 does not implement DeformConv. ONNX's official static
# ReferenceEvaluator covers this fixture and is used as the numerical oracle.
